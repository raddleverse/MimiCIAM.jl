...
function initciam(xsc, params, initparams, m::Model, fixed::Bool=false,t::Int=20,noRetreat::Bool=false,allowMaintain::Bool=true,popinput::Int=0)
    ...
    set_param!(m, :slrcost, :popinput, popinput)
...
function get_model(;initfile=nothing,fixed::Bool=false,t::Int=20,noRetreat::Bool=false,allowMaintain::Bool=true, popinput::Int=0)
    ...
    initciam(xsc, params, initparams, m, fixed, t,noRetreat,allowMaintain, popinput)
